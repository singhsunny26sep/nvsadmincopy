      ...
      <body>
        <div class="invoice-container">
          ...
          <table class="items">
            ...
            <tbody>
              ${t.items&&t.items.length>0?t.items.map((g,Z)=>{var L;return`
                <tr>
                  <td>${Z+1}</td>
                  <td>${(((L=g.product)==null?void 0:L.name)||"Unknown").substring(0,22)}</td>
                  <td>${g.quantity}</td>
